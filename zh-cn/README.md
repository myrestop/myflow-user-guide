...
**本地同步服务：** 是一个简单的内置数据同步服务，我们会将**加密**后的数据更改日志写到您选择的目录里，并且也会从该目录读取日志来同步数据，所以要实现跨平台同步数据，你还需要将这个目录添加到第三方云盘的同步服务中，比如：Onedrive，Google Drive，iCloud，Dropbox或其他任何云盘服务。
